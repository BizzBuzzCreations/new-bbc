...
export const INDUSTRY_PAGE_CONTENT = {
  ...
  "social-media": {
    capabilities: [
      { icon: Share2, title: "Consistent Voice & Content", desc: "A content system built to keep an audience engaged with a consistent, recognizable voice." },
      { icon: Megaphone, title: "Paid Amplification", desc: "Paid campaigns that amplify your best content to the audiences most likely to engage." },
      { icon: Bot, title: "AI-Assisted Content Planning", desc: "AI tools that help plan and adapt content as platform algorithms shift." },
      { icon: ShieldCheck, title: "Careful, Scoped Data Handling", desc: "Access to your accounts is scoped to what's needed, with an NDA available before any project details are shared." },
      { icon: Users, title: "Community Management at Scale", desc: "Real process for community management, not ad-hoc replies whenever someone has time." },
      { icon: Star, title: "Consultancy on Platform Strategy", desc: "Strategic guidance to stay ahead of algorithm shifts instead of chasing last year's tactics." },
    ],
    spectrumSubtitle:
      "From growing an audience to keeping it consistently engaged — here's what we bring to a social-first brand engagement.",
    spectrumServices: buildSpectrumServices([
      { title: "Social Content Strategy", desc: "A content system built to grow an audience with a consistent, recognizable voice." },
      { title: "Paid Social Amplification", desc: "Paid campaigns that put your best content in front of the audiences most likely to engage." },
      { title: "AI-Assisted Content Planning", desc: "AI tools that help plan and adapt content as platform algorithms shift." },
      { title: "Community Management", desc: "Real process for community management at scale, not ad-hoc replies." },
      { title: "Business Consultancy", desc: "Strategic guidance to stay ahead of algorithm shifts, not chase last year's tactics." },
      { title: "Analytics & Reporting", desc: "Clear reporting on what's actually driving engagement and growth, not vanity metrics." },
    ]),
    whoWeHelpSubtitle:
      "Every social-first brand grows differently — the strategy that works for a creator rarely works the same way for a company account.",
    whoWeHelp: [
      { icon: ThumbsUp, title: "Consumer Brands & DTC Companies", desc: "Content strategy built to turn social engagement into a measurable business outcome." },
      { icon: MessageCircle, title: "Community-Led Platforms", desc: "Community management systems built for platforms where engagement is the product." },
      { icon: Camera, title: "Creators & Personal Brands", desc: "Consistent content strategy for creators building an audience around a personal voice." },
      { icon: Hash, title: "Niche & Interest-Based Brands", desc: "Focused content strategy for brands growing within a specific, engaged community." },
      { icon: Users, title: "Agencies & Multi-Brand Managers", desc: "Scalable process for teams managing social presence across multiple accounts." },
      { icon: Megaphone, title: "Campaign-Driven Brands", desc: "Paid amplification strategy for brands running time-bound social campaigns." },
    ],
    deliverables: [
      { number: "01", title: "Content Calendar & Strategy", desc: "A consistent content plan built around a recognizable, ongoing brand voice." },
      { number: "02", title: "Paid Amplification Campaigns", desc: "Paid campaigns that put your best-performing content in front of the right audience." },
      { number: "03", title: "Community Management Process", desc: "A real process for community management at scale, not ad-hoc replies." },
      { number: "04", title: "Algorithm-Aware Strategy Updates", desc: "Ongoing strategy adjustments as platform algorithms shift, instead of static tactics." },
      { number: "05", title: "Engagement-Focused Content Production", desc: "Content produced specifically around what's proven to drive real engagement." },
      { number: "06", title: "Monthly Performance Reporting", desc: "Clear reports on growth, engagement, and what's actually working — every month." },
    ],
    faqs: buildFaqs("Social Media", "We only need access to your social and ad accounts (platforms, analytics) — not private community data or DMs, which stay entirely within your own accounts."),
    trustPoints: buildTrustPoints("Social Media"),
  },
