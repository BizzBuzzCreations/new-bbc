    ...
    sections: [
            ...
            default: [
              {
                ...
                image: "/oneteam-multiplecapabilities.jpg",
              },
              {
                tag: "Why It's Different",
                value: "02.",
                ...
                image: "/solutionbuilt-aroundus.jpg",
              },
              {
                tag: "Why It's Different",
                value: "03.",
              ...
              },
              {
                ...
                image: "/builtto-adaptwithyou.jpg",
              },
            ],
          },
        ],
      ...
      },
      {
        ...
        fields: [
          ...
          {
            key: "ctaImage",
            label: "Right Side Image (optional)",
            type: "image",
            default: "",
          },
        ],
...
// Video client testimonial card shown right below Customer Reviews — on
// this page only (the real homepage has no such section). The whole card
// stays hidden on the live page until a video is uploaded, so the page
// never shows an empty player or placeholder client copy.
const VIDEO_TESTIMONIAL_SECTION = {
  key: "videoTestimonial",
  label: "Video Client Testimonial (below Customer Reviews — hidden until a video is uploaded)",
  fields: [
    {
      key: "videoTestimonialVideo",
      label: "Client Video",
      type: "video",
      default: "/client-testimonial.mp4",
    },
    {
      key: "videoTestimonialPoster",
      label: "Video Cover Image (optional, shown before play)",
      type: "image",
      default: "",
    },
    { key: "videoTestimonialEyebrow", label: "Small Label", type: "text", default: "Client Testimonial" },
    {
      key: "videoTestimonialHeading",
      label: "Heading",
      type: "text",
      default: "Real Results, In Their Own Words",
    },
    {
      key: "videoTestimonialQuote",
      label: "Client Quote / About the Client",
      type: "textarea",
      default:
        "Working with BizzBuzz Creations has been a genuine turning point for our business. From the very first call they took the time to understand our goals, then built a digital marketing plan that actually fit our budget. Their team is responsive, transparent with reporting, and always one step ahead — we've seen more enquiries, stronger visibility online, and a brand we're proud to show off.",
    },
    { key: "videoTestimonialClientName", label: "Client Name", type: "text", default: "Chris Stevenson" },
    {
      key: "videoTestimonialClientRole",
      label: "Client Role & Company",
      type: "text",
      default: "Founder, Open Path Project — United Kingdom",
    },
    {
      key: "videoTestimonialHighlights",
      label: "Result Highlights (optional)",
      type: "list",
      default: [],
      itemFields: [
        { key: "value", label: "Value (e.g. 3x)", type: "text" },
        { key: "label", label: "Label (e.g. More Leads)", type: "text" },
      ],
    },
  ],
};
...
export const OUTSIDE_LOCATION_REGISTRY = [
  {
    ...
    sections: HOME_SECTIONS.flatMap((s) => {
      if (s.key === "hero") return [OUTSIDE_LOCATION_HERO_SECTION];
      if (s.key === "reviews") return [s, VIDEO_TESTIMONIAL_SECTION];
      return [s];
    }),
  },
];
