    ...
    sections: [
      ...
      },
      {
        ...
        fields: [
          ...
          {
            key: "leaders",
            label: "Leader Cards (icon order fixed: SEO, Paid Ads, Creative, Engineering, AI, Consultancy, Team) — hover to flip and reveal name + LinkedIn/Instagram. No department tag anymore — just name + role.",
            type: "list",
            itemFields: [
              { key: "role", label: "Role", type: "text" },
            ...
            default: [
              { role: "Compliance Manager", name: "Abhay Sharma", linkedin: "", instagram: "" },
              { role: "Process Manager", name: "Kautic Jaiswal", linkedin: "", instagram: "" },
              { role: "Team Leader", name: "Swapnil Singh", linkedin: "", instagram: "" },
              { role: "Organizational Manager", name: "Shruti Singh", linkedin: "", instagram: "" },
              { role: "HR", name: "Aley Saiyyadah Rizvi", linkedin: "", instagram: "" },
              { role: "IT Manager", name: "Md. Shameem", linkedin: "", instagram: "" },
              { role: "Accounts and Management", name: "Ankit Kumar Yadav", linkedin: "", instagram: "" },
            ],
          },
        ],
      },
